                        ...
                        self._spawnFfmpeg(args, {
                            ...
                            if (self.options.timeout) {
                                self.processTimer = setTimeout(function () {
                                    var msg = "process ran into a timeout (" +
        ...
        if (!utils.isWindows) {
            ...
            if (this.ffmpegProc) {
                ...
                renice.on("exit", function (code, signal) {
                    if (signal) {
                        logger.warn("could not renice process " +
                            pid +
                        ...
                        logger.info("successfully reniced process " +
                            pid +
                            " to " +
                            niceness +
                            " niceness");
